...
abstract class DBconnClass {

    // set from here *************************
    // private static $db_host = 'localhost';
    // private static $db_user = 'root';
    // private static $db_pass = '';
    // protected $db_name  = "miguia_clasificados";
    // set from here *************************
    private static $db_host = 'localhost';
    private static $db_user = 'j8000032_miguia';
    private static $db_pass = 'koti33FOpu';
    protected $db_name = 'j8000032_miguia';
    ...
    protected function get_results_from_query2() {
        $this->open_connection();
        $this->conn->query($this->query);
        if(!$this->conn->error) {
                return TRUE;
