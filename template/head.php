							...
							<div class="headertop">
								<div class="container">
									<div class="row">
										...
										<div class="col-2 col-12-mobile" id="topbutton">
											<div class="button text-right ">
												<a href="#contactarea" class="scrolly">Consultas</a>
											</div>
										</div>
									</div>
								</div>
							...
							<div class="headerbottom">
								...
								<nav id="nav">
									<ul>
										...
										<li><a href="left-sidebar.html">Nosotros</a></li>
										<li><a href="right-sidebar.html">Áreas</a></li>
										<li><a href="no-sidebar.html">Testimonios</a></li>
										<li><a href="no-sidebar.html">Equipo</a></li>
