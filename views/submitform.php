    ...
    if(isset($_POST['upcita']) == 'Solicitar cita'){
        ...
        if ($_POST['abogada'] == '' && $_POST['hora'] == '') {
            ...
            if(!$mail2->send()){echo 'Error: '.$mail2->ErrorInfo;}else{
                ...
                echo '<div class="wrapper"><div class="container"><div class="row"><div class="msj-ok"><h2>Gracias por solicitar tu cita con nuestras abogadas. En breve recibirás un email con los datos necesarios para poder concretar tu asesoramiento</a></p><div class="button text-right ">
